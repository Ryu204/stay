...
#include "stay/graphics/render.hpp" // IWYU pragma: export
#include "stay/graphics/cameraController.hpp" // IWYU pragma: export
#include "stay/graphics/animation.hpp" // IWYU pragma: export
